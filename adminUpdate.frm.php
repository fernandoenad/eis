			...
			<div class="row">
				<div class="col-lg-12 col-md-12">
					<div class="form-group">
						...
						<input type="text" id="user_fullname" <?php echo (isset($_SESSION["userid"]) && $_SESSION["userid"]==1?"":"disabled");?> name="user_fullname" required="required" class=" form-control" value="<?php echo $dataUser['user_fullname'];?>" >
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-12 col-md-12">
					<div class="form-group">
						...
						<select id="user_role" name="user_role" required="required" class=" form-control">
							...
							<option value="2" <?php echo (2==$dataUser['user_role'])?"selected":"";?>>Personnel</option>
