...
<tr>
<?php
$result= dbquery("SELECT * FROM studenroll INNER JOIN student ON studenroll.enrol_stud_no=student.stud_no WHERE (studenroll.enrol_sy='".$_GET['enrol_sy']."' AND student.stud_gender='MALE' $filter) ORDER BY enrol_level ASC, enrol_section asc, stud_lname ASC, stud_fname ASC");
$rows = dbrows($result);
?>
...
<td>&nbsp;</td>
<?php
$result= dbquery("SELECT * FROM studenroll INNER JOIN student on studenroll.enrol_stud_no=student.stud_no WHERE (studenroll.enrol_sy='".$_GET['enrol_sy']."' AND student.stud_gender='FEMALE' $filter) ORDER BY enrol_level ASC, enrol_section asc, stud_lname ASC, stud_fname ASC");
$rows = dbrows($result);
?>
