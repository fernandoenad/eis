		...
		?>
			...
			<table border="1" cellspacing="0" cellpadding="1" width="780">
				...
				<tr height="20">
					...
					<td align="center"><strong><?php echo $dataForm137['enrol_status2'];?></strong></td>
				</tr>
			</table>
			</td>
			</tr>
...
?>
		...
		<table border="0" cellspacing="1" cellpadding="0" width="780">
			<tr height="35">
				<td>
					School: &nbsp;<u><strong><?php echo ($dataForm137['enrol_school']==""?"___________________________":strtoupper($dataForm137['enrol_school']));?></strong></u> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					School ID: &nbsp;<u><strong><?php echo ($dataForm137['enrol_school']!=""?$current_school_code:"____________");?></strong></u> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					District: &nbsp;<u><strong><?php echo ($dataForm137['enrol_school']!=""?$current_school_district:"____________");?></strong></u> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					Division: &nbsp;<u><strong><?php echo ($dataForm137['enrol_school']!=""?$current_school_division:"____________");?></strong></u> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					Region: &nbsp;<u><strong><?php echo ($dataForm137['enrol_school']!=""?$current_school_reg_code:"____________");?></strong></u> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
					Classified as Grade: &nbsp;<u><strong><?php echo ($dataForm137['enrol_level']!=""?$current_school_reg_code:"___");?></strong></u> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					Section: &nbsp;<u><strong><?php echo ($dataForm137['enrol_section']==""?"_____________":$dataForm137['enrol_section']);?></strong></u> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					$dataAdviser = dbarray($checkAdviser );
					?>
					Name of Adviser/Teacher: &nbsp;<u><strong><?php echo ($dataAdviser['user_fullname']==""?"_____________________":($dataAdviser['user_no']=="1"?"TBA":strtoupper($dataAdviser['user_fullname'])));?></strong></u> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	
