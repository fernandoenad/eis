...
<!-- Modal content-->
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">School Enrollment Summary - Annual </h4>
      </div>
		...
		<div class="card-body">
				<table class="table table-condensed">
					...
					<tr>
						...
						<td><a href="" onclick="window.open('classList2.php?enrol_sy=<?php echo $_GET['enrol_sy'];?>&classProfile=<?php echo $dataClasses['section_name'];?>&status=all', '', 'width=850, height=600'); return false;"><?php echo $dataClasses['section_name'];?></a></td>
						<?php
					...
					<tr align="center">
						<td></td>
						<td align="right"><b><a href="" onclick="window.open('classList3.php?enrol_sy=<?php echo $_GET['enrol_sy'];?>&classProfile=<?php echo $dataClasses['section_name'];?>&status=all', '', 'width=850, height=600'); return false;"><?php echo $dataClasses['section_name'];?>TOTAL</a></td>
