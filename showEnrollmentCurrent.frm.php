      ...
      <div class="modal-body">
		<div class="card-body">
				<table class="table table-condensed">
					...
					<tr align="center">
						<td></td>
						<td align="right"><b><a href="" onclick="window.open('classList3.php?enrol_sy=<?php echo $_GET['enrol_sy'];?>&classProfile=<?php echo $dataClasses['section_name'];?>&status=current', '', 'width=850, height=600'); return false;"><?php echo $dataClasses['section_name'];?>TOTAL</a></td>
