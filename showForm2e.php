	...
	<tr>
		...
		<td align="center" valign="top">
			...
			<table width="100%" border="0">
				<tr height="25">
					<td width="10%" align="right" ><font size="1"> &nbsp;</td>
					<td align="center" style=""><font size="1"><?php //echo $current_school_code;?></td>
					<td width="5%"></td>
					<td></td>
					<td width="8%" align="right"><font size="1"> &nbsp;</td>
					<td align="center" style=""><font size="1"><?php //echo $current_sy;?><?php //echo $current_sy+1;?></td>
					<td width="5%"></td>
				...
				<tr height="25">
					<td align="right" border="1"><font size="1">Office Name &nbsp;</td>
	...
	<tr>
		...
		<td width="30%" valign="top">
			...
			<table width="100%">
				...
				<tr><td align="center"><br><br><strong><?php echo $current_principal;?></strong><br>(Signature of Admin Officer V over Printed Name)</td></tr>
			</table>
		</td>
	</tr>
</table>
