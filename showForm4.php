...
<table border="1" cellspacing="0" cellpadding="1" width="1135">
	...
	$checkSections = dbquery("SELECT * FROM section INNER JOIN users ON section_adviser=user_no WHERE section_sy='".$_GET['enrol_sy']."' and section_level<='".$limit."' ORDER BY section_level ASC, section_name ASC");
...
<?php
	$limit = ($current_school_maxlevel>10?10:$current_school_maxlevel);
	$checkSections = dbquery("SELECT * FROM section INNER JOIN users ON section_adviser=user_no WHERE section_sy='".$_GET['enrol_sy']."' and section_level<='".$limit."' GROUP BY section_level ORDER BY section_level ASC, section_name ASC");
	while($dataSections = dbarray($checkSections)){
		if(substr($dataSections['section_name'],0,2)=="Z_"){}
		else{
	?>
	...
	?>
		<tr>
			...
			<?php
				$checkEnrolM = dbquery("SELECT * FROM studenroll INNER JOIN student on enrol_stud_no=stud_no WHERE (enrol_sy='".$_GET['enrol_sy']."' AND enrol_section!='' and enrol_admitdate <= '".$dateLimit."' AND stud_gender='MALE' and enrol_level<='".$limit."' AND (enrol_status1='ENROLLED' OR enrol_status1='PROMOTED'))");
				$countEnrolM = dbrows($checkEnrolM);
				$checkEnrolF = dbquery("SELECT * FROM studenroll INNER JOIN student on enrol_stud_no=stud_no WHERE (enrol_sy='".$_GET['enrol_sy']."' AND enrol_section!='' and enrol_admitdate <= '".$dateLimit."' AND stud_gender='FEMALE'  and enrol_level<='".$limit."' AND (enrol_status1='ENROLLED' OR enrol_status1='PROMOTED'))");
				$countEnrolF = dbrows($checkEnrolF);
				$checkEnrolT = dbquery("SELECT * FROM studenroll INNER JOIN student on enrol_stud_no=stud_no WHERE (enrol_sy='".$_GET['enrol_sy']."' AND enrol_section!='' and enrol_admitdate <= '".$dateLimit."'  and enrol_level<='".$limit."' AND (enrol_status1='ENROLLED' OR enrol_status1='PROMOTED'))");
				$countEnrolT = dbrows($checkEnrolT);
			?>
			<td align="right" width="2%"><?php echo number_format($countEnrolM,0);?></td>
			<td align="right" width="2%"><?php echo number_format($countEnrolF,0);?></td>
			...
			<?php
				$checkMonth = $_GET['classProfile'];
				$checkAttM = dbquery("SELECT SUM($checkMonth) as  mon_sum FROM studenroll INNER JOIN student on enrol_stud_no=stud_no INNER JOIN school_days ON stud_no=sch_stud_no WHERE (sch_sy='".$_GET['enrol_sy']."'  and enrol_level<='".$limit."' AND enrol_sy='".$_GET['enrol_sy']."' and enrol_admitdate <= '".$dateLimit."' AND stud_gender='MALE' AND (enrol_status1='ENROLLED' OR enrol_status1='PROMOTED'))");
				$countAttM = dbarray($checkAttM);
				$checkAttF = dbquery("SELECT SUM($checkMonth) as  mon_sum FROM studenroll INNER JOIN student on enrol_stud_no=stud_no INNER JOIN school_days ON stud_no=sch_stud_no WHERE (sch_sy='".$_GET['enrol_sy']."'  and enrol_level<='".$limit."' AND enrol_sy='".$_GET['enrol_sy']."' and enrol_admitdate <= '".$dateLimit."' AND stud_gender='FEMALE' AND (enrol_status1='ENROLLED' OR enrol_status1='PROMOTED'))");
				$countAttF = dbarray($checkAttF);
				$checkAttT = dbquery("SELECT SUM($checkMonth) as  mon_sum FROM studenroll INNER JOIN student on enrol_stud_no=stud_no INNER JOIN school_days ON stud_no=sch_stud_no WHERE (sch_sy='".$_GET['enrol_sy']."'  and enrol_level<='".$limit."' AND enrol_sy='".$_GET['enrol_sy']."' and enrol_admitdate <= '".$dateLimit."' AND (enrol_status1='ENROLLED' OR enrol_status1='PROMOTED'))");
				$countAttT = dbarray($checkAttT);
				$checkDay = dbquery("SELECT SUM($checkMonth) as mon_sum FROM school_days WHERE (sch_sy='".$_GET['enrol_sy']."' AND sch_stud_no='".$_GET['enrol_sy']."')");
				$dataDay = dbarray($checkDay);
			...
			<?php
				$checkEnrolM = dbquery("SELECT * FROM studenroll INNER JOIN student on enrol_stud_no=stud_no WHERE (enrol_sy='".$_GET['enrol_sy']."' and enrol_level<='".$limit."'and enrol_graddate <= '".$prevLimit."' AND stud_gender='MALE' AND enrol_status2='DROPPED OUT')");
				$countEnrolM = dbrows($checkEnrolM);
				$checkEnrolF = dbquery("SELECT * FROM studenroll INNER JOIN student on enrol_stud_no=stud_no WHERE (enrol_sy='".$_GET['enrol_sy']."' and enrol_level<='".$limit."' and enrol_graddate <= '".$prevLimit."' AND stud_gender='FEMALE' AND enrol_status2='DROPPED OUT')");
				$countEnrolF = dbrows($checkEnrolF);
				$checkEnrolT = dbquery("SELECT * FROM studenroll INNER JOIN student on enrol_stud_no=stud_no WHERE (enrol_sy='".$_GET['enrol_sy']."' and enrol_level<='".$limit."' and enrol_graddate <= '".$prevLimit."' AND enrol_status2='DROPPED OUT')");
				$countEnrolT = dbrows($checkEnrolT);
			?>
			<td align="right" width="2%"><?php echo number_format($countEnrolM,0);?></td>
			<td align="right" width="2%"><?php echo number_format($countEnrolF,0);?></td>
			...
			<?php
				$checkEnrolM = dbquery("SELECT * FROM studenroll INNER JOIN student on enrol_stud_no=stud_no WHERE (enrol_sy='".$_GET['enrol_sy']."' and enrol_level<='".$limit."' and (enrol_graddate > '".$prevLimit."' and enrol_graddate <= '".$dateLimit."') AND stud_gender='MALE' AND enrol_status2='DROPPED OUT')");
				$countEnrolM = dbrows($checkEnrolM);
				$checkEnrolF = dbquery("SELECT * FROM studenroll INNER JOIN student on enrol_stud_no=stud_no WHERE (enrol_sy='".$_GET['enrol_sy']."' and enrol_level<='".$limit."' and (enrol_graddate > '".$prevLimit."' and enrol_graddate <= '".$dateLimit."') AND stud_gender='FEMALE' AND enrol_status2='DROPPED OUT')");
				$countEnrolF = dbrows($checkEnrolF);
				$checkEnrolT = dbquery("SELECT * FROM studenroll INNER JOIN student on enrol_stud_no=stud_no WHERE (enrol_sy='".$_GET['enrol_sy']."' and enrol_level<='".$limit."' and (enrol_graddate > '".$prevLimit."' and enrol_graddate <= '".$dateLimit."') AND enrol_status2='DROPPED OUT')");
				$countEnrolT = dbrows($checkEnrolT);
			?>
			<td align="right" width="2%" bgcolor="lightgray"><?php echo number_format($countEnrolM,0);?></td>
			<td align="right" width="2%" bgcolor="lightgray"><?php echo number_format($countEnrolF,0);?></td>
			...
			<?php
				$checkEnrolM = dbquery("SELECT * FROM studenroll INNER JOIN student on enrol_stud_no=stud_no WHERE (enrol_sy='".$_GET['enrol_sy']."' and enrol_level<='".$limit."' and enrol_graddate <= '".$dateLimit."' AND stud_gender='MALE' AND enrol_status2='DROPPED OUT')");
				$countEnrolM = dbrows($checkEnrolM);
				$checkEnrolF = dbquery("SELECT * FROM studenroll INNER JOIN student on enrol_stud_no=stud_no WHERE (enrol_sy='".$_GET['enrol_sy']."' and enrol_level<='".$limit."' and enrol_graddate <= '".$dateLimit."' AND stud_gender='FEMALE' AND enrol_status2='DROPPED OUT')");
				$countEnrolF = dbrows($checkEnrolF);
				$checkEnrolT = dbquery("SELECT * FROM studenroll INNER JOIN student on enrol_stud_no=stud_no WHERE (enrol_sy='".$_GET['enrol_sy']."' and enrol_level<='".$limit."' and enrol_graddate <= '".$dateLimit."' AND enrol_status2='DROPPED OUT')");
				$countEnrolT = dbrows($checkEnrolT);
			?>
			<td align="right" width="2%"><?php echo number_format($countEnrolM,0);?></td>
			<td align="right" width="2%"><?php echo number_format($countEnrolF,0);?></td>
			...
			<?php
				$checkEnrolM = dbquery("SELECT * FROM studenroll INNER JOIN student on enrol_stud_no=stud_no WHERE (enrol_sy='".$_GET['enrol_sy']."' and enrol_level<='".$limit."' and enrol_graddate <= '".$prevLimit."' AND stud_gender='MALE' AND enrol_status2='TRANSFERRED OUT')");
				$countEnrolM = dbrows($checkEnrolM);
				$checkEnrolF = dbquery("SELECT * FROM studenroll INNER JOIN student on enrol_stud_no=stud_no WHERE (enrol_sy='".$_GET['enrol_sy']."' and enrol_level<='".$limit."' and enrol_graddate <= '".$prevLimit."' AND stud_gender='FEMALE' AND enrol_status2='TRANSFERRED OUT')");
				$countEnrolF = dbrows($checkEnrolF);
				$checkEnrolT = dbquery("SELECT * FROM studenroll INNER JOIN student on enrol_stud_no=stud_no WHERE (enrol_sy='".$_GET['enrol_sy']."' and enrol_level<='".$limit."' and enrol_graddate <= '".$prevLimit."' AND enrol_status2='TRANSFERRED OUT')");
				$countEnrolT = dbrows($checkEnrolT);
			?>
			<td align="right" width="2%"><?php echo number_format($countEnrolM,0);?></td>
			<td align="right" width="2%"><?php echo number_format($countEnrolF,0);?></td>
			...
			<?php
				$checkEnrolM = dbquery("SELECT * FROM studenroll INNER JOIN student on enrol_stud_no=stud_no WHERE (enrol_sy='".$_GET['enrol_sy']."' and enrol_level<='".$limit."' and (enrol_graddate > '".$prevLimit."' and enrol_graddate <= '".$dateLimit."') AND stud_gender='MALE' AND enrol_status2='TRANSFERRED OUT')");
				$countEnrolM = dbrows($checkEnrolM);
				$checkEnrolF = dbquery("SELECT * FROM studenroll INNER JOIN student on enrol_stud_no=stud_no WHERE (enrol_sy='".$_GET['enrol_sy']."' and enrol_level<='".$limit."' and (enrol_graddate > '".$prevLimit."' and enrol_graddate <= '".$dateLimit."') AND stud_gender='FEMALE' AND enrol_status2='TRANSFERRED OUT')");
				$countEnrolF = dbrows($checkEnrolF);
				$checkEnrolT = dbquery("SELECT * FROM studenroll INNER JOIN student on enrol_stud_no=stud_no WHERE (enrol_sy='".$_GET['enrol_sy']."' and enrol_level<='".$limit."' and (enrol_graddate > '".$prevLimit."' and enrol_graddate <= '".$dateLimit."') AND enrol_status2='TRANSFERRED OUT')");
				$countEnrolT = dbrows($checkEnrolT);
			?>
			<td align="right" width="2%" bgcolor="lightgray"><?php echo number_format($countEnrolM,0);?></td>
			<td align="right" width="2%" bgcolor="lightgray"><?php echo number_format($countEnrolF,0);?></td>
			...
			<?php
				$checkEnrolM = dbquery("SELECT * FROM studenroll INNER JOIN student on enrol_stud_no=stud_no WHERE (enrol_sy='".$_GET['enrol_sy']."' and enrol_level<='".$limit."' and enrol_graddate <= '".$dateLimit."' AND stud_gender='MALE' AND enrol_status2='TRANSFERRED OUT')");
				$countEnrolM = dbrows($checkEnrolM);
				$checkEnrolF = dbquery("SELECT * FROM studenroll INNER JOIN student on enrol_stud_no=stud_no WHERE (enrol_sy='".$_GET['enrol_sy']."' and enrol_level<='".$limit."' and enrol_graddate <= '".$dateLimit."' AND stud_gender='FEMALE' AND enrol_status2='TRANSFERRED OUT')");
				$countEnrolF = dbrows($checkEnrolF);
				$checkEnrolT = dbquery("SELECT * FROM studenroll INNER JOIN student on enrol_stud_no=stud_no WHERE (enrol_sy='".$_GET['enrol_sy']."' and enrol_level<='".$limit."' and enrol_graddate <= '".$dateLimit."' AND enrol_status2='TRANSFERRED OUT')");
				$countEnrolT = dbrows($checkEnrolT);
			?>
			<td align="right" width="2%"><?php echo number_format($countEnrolM,0);?></td>
			<td align="right" width="2%"><?php echo number_format($countEnrolF,0);?></td>
			...
			<?php
				$checkEnrolM = dbquery("SELECT * FROM studenroll INNER JOIN student on enrol_stud_no=stud_no WHERE (enrol_sy='".$_GET['enrol_sy']."' and enrol_level<='".$limit."' and enrol_admitdate <= '".$prevLimit."' AND stud_gender='MALE' AND enrol_ti='1')");
				$countEnrolM = dbrows($checkEnrolM);
				$checkEnrolF = dbquery("SELECT * FROM studenroll INNER JOIN student on enrol_stud_no=stud_no WHERE (enrol_sy='".$_GET['enrol_sy']."' and enrol_level<='".$limit."' and enrol_admitdate <= '".$prevLimit."' AND stud_gender='FEMALE' AND enrol_ti='1')");
				$countEnrolF = dbrows($checkEnrolF);
				$checkEnrolT = dbquery("SELECT * FROM studenroll INNER JOIN student on enrol_stud_no=stud_no WHERE (enrol_sy='".$_GET['enrol_sy']."' and enrol_level<='".$limit."' and enrol_admitdate <= '".$prevLimit."' AND enrol_ti='1')");
				$countEnrolT = dbrows($checkEnrolT);
			?>
			<td align="right" width="2%"><?php echo number_format($countEnrolM,0);?></td>
			<td align="right" width="2%"><?php echo number_format($countEnrolF,0);?></td>
			...
			<?php
				$checkEnrolM = dbquery("SELECT * FROM studenroll INNER JOIN student on enrol_stud_no=stud_no WHERE (enrol_sy='".$_GET['enrol_sy']."' and enrol_level<='".$limit."' and (enrol_admitdate > '".$prevLimit."' and enrol_admitdate <= '".$dateLimit."') AND stud_gender='MALE' AND enrol_ti='1')");
				$countEnrolM = dbrows($checkEnrolM);
				$checkEnrolF = dbquery("SELECT * FROM studenroll INNER JOIN student on enrol_stud_no=stud_no WHERE (enrol_sy='".$_GET['enrol_sy']."' and enrol_level<='".$limit."' and (enrol_admitdate > '".$prevLimit."' and enrol_admitdate <= '".$dateLimit."') AND stud_gender='FEMALE' AND enrol_ti='1')");
				$countEnrolF = dbrows($checkEnrolF);
				$checkEnrolT = dbquery("SELECT * FROM studenroll INNER JOIN student on enrol_stud_no=stud_no WHERE (enrol_sy='".$_GET['enrol_sy']."' and enrol_level<='".$limit."' and (enrol_admitdate > '".$prevLimit."' and enrol_admitdate <= '".$dateLimit."') AND enrol_ti='1')");
				$countEnrolT = dbrows($checkEnrolT);
			?>
			<td align="right" width="2%" bgcolor="lightgray"><?php echo number_format($countEnrolM,0);?></td>
			<td align="right" width="2%" bgcolor="lightgray"><?php echo number_format($countEnrolF,0);?></td>
			...
			<?php
				$checkEnrolM = dbquery("SELECT * FROM studenroll INNER JOIN student on enrol_stud_no=stud_no WHERE (enrol_sy='".$_GET['enrol_sy']."' and enrol_level<='".$limit."' and enrol_admitdate <= '".$dateLimit."' AND stud_gender='MALE' AND enrol_ti='1')");
				$countEnrolM = dbrows($checkEnrolM);
				$checkEnrolF = dbquery("SELECT * FROM studenroll INNER JOIN student on enrol_stud_no=stud_no WHERE (enrol_sy='".$_GET['enrol_sy']."' and enrol_level<='".$limit."' and enrol_admitdate <= '".$dateLimit."' AND stud_gender='FEMALE' AND enrol_ti='1')");
				$countEnrolF = dbrows($checkEnrolF);
				$checkEnrolT = dbquery("SELECT * FROM studenroll INNER JOIN student on enrol_stud_no=stud_no WHERE (enrol_sy='".$_GET['enrol_sy']."' and enrol_level<='".$limit."' and enrol_admitdate <= '".$dateLimit."' AND enrol_ti='1')");
				$countEnrolT = dbrows($checkEnrolT);
			?>
			<td align="right" width="2%"><?php echo number_format($countEnrolM,0);?></td>
			<td align="right" width="2%"><?php echo number_format($countEnrolF,0);?></td>
...
<table width="1135">
	<tr align="center" valign="">
		...
		<b>GUIDELINES:</b><br>
		1. This form shall be accomplished every end of the month using the summary box of SF2 submitted by the teachers/advisers to update figures for the month. <br>																					
		2. Furnish the Division Office with a copy a week after June 30, October 30 & March 31.<br>		
		3.  Only teachers who are handling advisory class shall be reported.  May use additional copy/ies of this form if needed.<br>	
