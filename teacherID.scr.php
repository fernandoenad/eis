...
if(isset($_GET['UpdateBiometricID']) && $_GET['UpdateBiometricID']=="Yes"){
	$result1 = dbquery("UPDATE teacher SET teach_bio_no='".$_POST['teach_bio_no']."', teach_tin='".$_POST['teach_tin']."', teach_dialect='".$_POST['teach_dialect']."' WHERE teach_no='".$_POST['teach_no']."'");	
	header("Location: ".$_SERVER['HTTP_REFERER']);
}
?>