...
?>
		...
		<div class="pagecontent container">
			...
			<ol class="breadcrumb">
				<li><a href="<?php echo($_SESSION["user_role"]==2?"#":"./?page=teacher");?>">Personnel</a></li>
				<li class="active">Personnel Profile</li>
			</ol>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
					<div class="row-fluid">
						<div class="media">
							<?php
							$student_image = "./assets/images/teachers/".(isset($data['teach_no'])?$data['teach_no']:"").".jpg";
							...
							<div class="media-body">
								...
								<h5> <span class="glyphicon glyphicon-credit-card"> <span style="font-size:13px;font-weight:normal"><?php echo $data['teach_dialect'];?></h5>
